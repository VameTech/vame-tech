...
<head>
  ...
  <script data-ad-client="ca-pub-4273553683972673" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>
            ...
            It's my pleasure to be on VAMETECH team a system that will be a turning point not only to schools but also parents.welcome all to the osmmas community 
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
              ...
              <p>
                ...
                I am delighted to have designed this web page the appearance of all functionalities amazes me too. I hope you are amazed as much as I am
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
             <img src="assets/img/alvinah.jfif" class="testimonial-img" alt=""> 
              <h3>Alvina Minja</h3>
          ...
          <div class="testimonial-item">
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
              Its a previlege as a person who was granted permission to test the security on the System.I assure every user that the system is secure and safe for use
              <i class="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
          ...
          <div class="testimonial-item">
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
              OSMMAS can and will be one of the best students management system. Dear schools and parents welcome to the platfrom you wont regret.
              <i class="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
          <img src="assets/img/vince.jpeg" class="testimonial-img" alt=""> 
            <h3>Vincent Simon</h3>
          ...
          <div class="testimonial-item">
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
              It's my pleasure to be one of OSMMAS developers a system that will be a turning point not only to schools but also parents.welcome all to the osmmas community 
              <i class="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
            <img src="assets/img/msira.jfif" class="testimonial-img" alt=""> 
            <h3>Deus Msira</h3>
          ...
          <div class="testimonial-item">
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
              Its my pleasure as a developer to be part of the contribution to the society ,I invite you all to use our best digital system
              <i class="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
           <img src="assets/img/aneth.jfif" class="testimonial-img" alt=""> 
            <h3>Anneth Nissar</h3>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">Portifolio</li>
